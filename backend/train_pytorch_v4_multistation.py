...
OUTPUT_MODEL = (
    ...
    / "app"
    / "models"
    / "skyguard_pytorch_multiclass_v4.pt"
)
...
print()
print("=" * 70)
print("V4 HELD-OUT TEST RESULTS")
print("=" * 70)
...
checkpoint = {
    ...
    "version":
        "SkyGuard PyTorch Multiclass V4",
